...
from Insta.views import PostView, ExploreView, PostDetail,PostCreateView,PostUpdateView,PostDeleteView, UserDetail, EditProfile, addLike,toggleFollow, addComment
